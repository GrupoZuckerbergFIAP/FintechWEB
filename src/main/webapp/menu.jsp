...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="cartao?acao=listarCartao">Cartão</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="despesa?acao=listarDespesa">Despesa</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="receita?acao=listarReceita">Receita</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="objetivo?acao=listarObjetivo">Objetivos</a>
      </li>
    </ul>
