...
<div class="container">
	...
	<form action="despesa" method="post">
		<input type="hidden" value="cadastrarDespesa" name="acao">
		...
		<div class="form-group">
			...
			<input type="text" name="valor" id="id-numero" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-dataTransacao">Data da Transação</label>
